...
<body class="staff-body">
	...
	<?PHP
		...
		{
			echo "<br><br><h1>All reservations for today are already Checked Out.</h1><br><br>".
		...
		else
		{
			echo 
				...
				echo "</TABLE><BR>".
				"<INPUT TYPE='submit' VALUE='Check Out Guest'><BR><BR><BR>".
				"<a href ='staff-home.php'><button type='button'>Back To Staff Homepage</button></a><BR><BR>";
				"</form><BR>";
		}
	mysql_close($conn);
