...
<body class="customer-body">
	...
	<header>
		...
		$query = "INSERT INTO waitinglist (RoomType, CustomerID, CheckInDate, CheckOutDate) 
				VALUES ('".$_SESSION['roomtype']."','".$_SESSION['customerid']."','".$_SESSION['checkin']."','".$_SESSION['checkout']."')";
		//echo $query;
		mysql_query($query, $conn);
		echo "<center>Waiting List Reservation Success! <br><br><button onclick=\"location.href='customer-home.php'\" type='button' align='middle' >Take me to the Home Page</button><br><br>";
		
		if(isset($_SESSION['employeeid'])){
		echo "<a href = 'viewwaitlist.php'>View Waiting List</a></center>";
		}
