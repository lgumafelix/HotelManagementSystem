...
<body class="staff-body">
	...
	<?PHP
		...
		{
			echo "<BR><BR><H1>Please select an employee to delete!</H1><BR><BR>".
				"<a href ='deletelistemployee.php'><button type='button'>Try Again</button></a>";
		}
		else
		{
			...
			if(!$retval){
				...
				echo "<H1>Employee has been successfully deleted!</H1>".
