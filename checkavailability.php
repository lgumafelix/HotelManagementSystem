	...
	<!--<BODY onload="document.forms[0].submit()"> -->
		...
		$newdateout = date('Y-m-d',$dateout);		
			...
			if ($result == false)
			{
				...
				<table BGCOLOR='white' border=\"5\" style=\"width:50\">
				  <tr>
					<th>First Name:</th>
				...
				<br>
				There are no rooms available for that time period.  Would you like to be added to the waitlist? <br><br>
				<button onclick=\"location.href='./addwaitinglistreservation.php'\" align='middle' >Add me to the Waitlist!</button><br><br>";
				if(isset($_SESSION['employeeid'])){
					echo "<button onclick=\"location.href='staff-home.php'\" type='button' align='middle' >Take me to the Home Page</button>
						</center>";
				} 		
				else {
					echo "<button onclick=\"location.href='./customer-home.php'\" type='button' align='middle' >Take me to the Home Page</button>
						</center>";
					}
			}
			else
			{
				...
				<br><button onclick=\"location.href='./payment.php'\" type='button' align='middle' >Enter Payment Information to Confirm Reservation</button><br><br>";
				if(isset($_SESSION['employeeid'])){
					echo "<button onclick=\"location.href='staff-home.php'\" type='button' align='middle' >Take me to the Home Page</button>
						</center>";
				} 		
