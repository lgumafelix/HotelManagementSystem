...
<body class="staff-body">
	...
	{
		echo "<BR><BR><H1>Please select a guest to check out!</H1><BR><BR>".
			"<a href ='todayrsvp2.php'><button type='button'>Try Again</button></a><BR><BR>".
	...
	else
	{
		...
		if(!$retval){
			...
			echo "<h1><br><br>Guest is now Checked Out!</h1><br><br>".
				"<a href = 'staff-home.php'><button type='button'>Back To Staff Homepage</button></a>";;
		}
	}
	mysql_close($conn);
